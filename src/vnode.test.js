...
// import { ShapeFlags, PatchFlags } from './shared/shapeFlags'
...
describe('vnode', () => {
  ...
  //   const mockInstance1 = { type: {} }
  //   const mockInstance2 = { type: {} }
  ...
  //     let props1  = { onClick: clickHandler1 }
  //     let props2  = { onClick: clickHandler2, onFocus: focusHandler2 }
  //     expect(mergeProps(props1, props2)).toMatchObject({
  //       onClick: [clickHandler1, clickHandler2],
  //       onFocus: focusHandler2
  //     })
  //     let props3  = { onClick: undefined }
